...
extern int *ant_solution; /* array de longitud numero hormigas * numero de caminos [n_ants*n] para guardar 0 o 1 dependiendo de si coge ese camino o no */
extern float *ant_score; /* array con tamaño numero de hormigas (tamaño de colonia) [n_ants] para guardar la puntuacion de cada una */
